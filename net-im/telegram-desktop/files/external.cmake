...
target_compile_definitions(desktop-app::external_qt
INTERFACE
	_REENTRANT
	QT_STATICPLUGIN
	QT_PLUGIN
...
target_compile_definitions(desktop-app::external_openal
INTERFACE
	AL_LIBTYPE_STATIC
	AL_ALEXT_PROTOTYPES
)
...
target_include_directories(desktop-app::external_zlib SYSTEM INTERFACE
...
target_link_libraries(desktop-app::external_openssl
INTERFACE
	OpenSSL::Crypto
	OpenSSL::SSL
)
target_link_libraries(desktop-app::external_qt
INTERFACE
	Qt5::DBus
	Qt5::Network
	Qt5::Widgets
)
target_link_options(desktop-app::external_qt
INTERFACE
	-static-libstdc++
	-pthread
	-rdynamic
...
target_link_libraries(desktop-app::external_opus INTERFACE
	${OPUS_LIBRARIES}
)
